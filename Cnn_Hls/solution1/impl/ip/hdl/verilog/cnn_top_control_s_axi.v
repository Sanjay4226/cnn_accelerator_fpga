...
localparam
    ...
    ADDR_OUTPUT_V_DATA_0 = 6'h18,
    ADDR_OUTPUT_V_CTRL   = 6'h1c,
    ADDR_KERNEL_V_DATA_0 = 6'h20,
    ADDR_KERNEL_V_CTRL   = 6'h24,
    WRIDLE               = 2'd0,
    WRDATA               = 2'd1,
    WRRESP               = 2'd2,
    WRRESET              = 2'd3,
    ...
    if (ACLK_EN) begin
        if (ar_hs) begin
            ...
            case (raddr)
                ...
                ADDR_KERNEL_V_DATA_0: begin
                    rdata <= int_kernel_V[31:0];
                end
            endcase
        end
    end
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_KERNEL_V_DATA_0)
            int_kernel_V[31:0] <= (WDATA[31:0] & wmask) | (int_kernel_V[31:0] & ~wmask);
    end
end
