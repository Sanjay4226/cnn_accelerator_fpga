set C_TypeInfoList {{ 
"conv2d" : [[], { "return": [[], "void"]} , [{"ExternC" : 0}], [ {"in": [[], {"array": [ {"array": [ {"scalar": "int"}, [32]]}, [32]]}] }, {"kernel": [[], {"array": [ {"array": [ {"scalar": "int"}, [3]]}, [3]]}] }, {"out": [[], {"array": [ {"array": [ {"scalar": "int"}, [30]]}, [30]]}] }],[],""]
}}
...
set C_modelArgList {
	{ in_r int 32 regular {array 1024 { 1 3 } 1 1 }  }
	{ kernel int 32 regular {array 9 { 1 3 } 1 1 }  }
	{ out_r int 32 regular {array 900 { 0 3 } 0 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "in_r", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "in","cData": "int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 31,"step" : 1},{"low" : 0,"up" : 31,"step" : 1}]}]}]} , 
 	...
 	{ "Name" : "out_r", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "out","cData": "int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 29,"step" : 1},{"low" : 0,"up" : 29,"step" : 1}]}]}]} ]}
...
set PerformanceInfo {[
	...
	, {"Name" : "Interval", "Min" : "39662", "Max" : "39662"}
]}
