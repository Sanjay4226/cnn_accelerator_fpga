...
`define AUTOTB_TVIN_in_r  "./c.conv2d.autotvin_in_r.dat"
`define AUTOTB_TVIN_kernel  "./c.conv2d.autotvin_kernel.dat"
`define AUTOTB_TVIN_out_r  "./c.conv2d.autotvin_out_r.dat"
`define AUTOTB_TVIN_in_r_out_wrapc  "./rtl.conv2d.autotvin_in_r.dat"
`define AUTOTB_TVIN_kernel_out_wrapc  "./rtl.conv2d.autotvin_kernel.dat"
`define AUTOTB_TVIN_out_r_out_wrapc  "./rtl.conv2d.autotvin_out_r.dat"
`define AUTOTB_TVOUT_out_r  "./c.conv2d.autotvout_out_r.dat"
`define AUTOTB_TVOUT_out_r_out_wrapc  "./impl_rtl.conv2d.autotvout_out_r.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 1;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 39661;
parameter LENGTH_in_r = 1024;
parameter LENGTH_kernel = 9;
parameter LENGTH_out_r = 900;
...
wire    [9 : 0]    arrayin_r_address0, arrayin_r_address1;
...
initial begin : generate_AESL_ready_cnt_proc
    ...
    initial begin : finish_simulation
        ...
        @ (posedge AESL_clock);
        @ (posedge AESL_clock);
    fp1 = $fopen("./rtl.conv2d.autotvout_out_r.dat", "r");
    fp2 = $fopen("./impl_rtl.conv2d.autotvout_out_r.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.conv2d.autotvout_out_r.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.conv2d.autotvout_out_r.dat\"!");
    else begin
        $display("Comparing rtl.conv2d.autotvout_out_r.dat with impl_rtl.conv2d.autotvout_out_r.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
